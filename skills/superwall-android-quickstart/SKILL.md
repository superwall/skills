---
name: superwall-android-quickstart
description: Superwall quickstart for native Android apps. Use for Android SDK setup.
---

# Superwall Android Quickstart

Implement the native Android SDK quickstart flow end-to-end.

## Use another skill when

- Project is Expo -> `superwall-expo-quickstart`
- Project is native iOS -> `superwall-ios-quickstart`
...
2. Inspect Android app/module boundaries and architecture.
